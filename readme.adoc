image:https://github.com/st-tu-dresden-praktikum/swt24w07/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt24w07/actions"]
...
* Must-Criteria F0304 from Pflichtenheft is not implemented 
