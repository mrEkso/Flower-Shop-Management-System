...
- Muss-Kriterien 2.4.2: kann nicht getestet werden, da es unmöglich ist, ein Festival freizugeben

- Muss-Kriterien 3.4: kann nicht getestet werden, da es unmöglich ist, ein Festival freizugeben
