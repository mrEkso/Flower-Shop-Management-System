...
- Artist-Name ist hardcoded zu "Name". Er kann nicht festgelegt werden.

image::./models/images/crosstesting_name.png[Die Spalte "Bereiche" in Festivaldetailübersicht trägt keine (offensichtliche) Information.]
