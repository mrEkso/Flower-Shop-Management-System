...
[[context_diagram]]
image::./models/images/context_diagram_c.svg[context diagram, 100%, 100%, pdfwidth=100%, title= "Kontextdiagramm für {project_name} in UML", align=center]

=== Top-Level-Architektur
[[top_level_diagram]]
image::./models/images/top_level_diagram_c.svg[top level diagram, 100%, 100%, pdfwidth=100%, title= "Top-Level-Architektur für {project_name} in UML", align=center]
...
[[use_case_diagram]]
image::./models/images/use_cases_c.svg[use case diagram, 100%, 100%, pdfwidth=100%, title= "Anwendungsfalldiagramm für {project_name} in UML", align=center]
...
image::./models/images/sequence_diagram_101_f.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 101 für {project_name} in UML", align=center]
...
|Extensions                 |-
|Funktionale Anforderungen    |<<F0103>>, <<F0102>>
|===
...
|Extensions                 |-
|Funktionale Anforderungen    |<<F0104>>, <<F0102>>
|===
...
image::./models/images/sequence_diagram_302_b.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 302 für {project_name} in UML", align=center]
...
|Beschreibungen             | Ein Kunde kann Blumen zur Abholung im Laden bestellen, entweder als einmalige Bestellung oder im Rahmen eines regelmäßigen Services (z. B. wöchentliche Blumenarrangements). Dieser Anwendungsfall erweitert den Anwendungsfall <<UC302>> Ein- bzw. mehrmaliges Blumenservice, da der Kunde anstelle einer Lieferung eine Abholung im Laden wählt.
|Akteure                    | Frau Floris, Nichte, Kunde
|Auslöser                   | Ein Kunde bestellt Blumenservice für eine Veranstaltung per Telefon. 
...
[[Sequencediagramm_303]]
image::./models/images/sequence_diagramm_303.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 303 für {project_name} in UML", align=center]
...
|Extensions                 |-
|Funktionale Anforderungen    | <<F0901>>
|===
...
| [[UC902]]<<UC902>>
| v0.1
| Großhändler-Katalog zum Testen simulieren
| Das System soll die Möglichkeit bieten, einen simulierten Katalog des Großhändlers für Testzwecke bereitzustellen. Dies ermöglicht das Testen der Bestellfunktionalität, ohne eine echte Verbindung zum Großhändler herstellen zu müssen.
...
[[Sales2]]
image::./models/images/sales2.png[Handlerpage,title= "SSales Page für Großhandler Bestellungen", 100%, 100%, pdfwidth=100%, align=center]

[[Services]]
image::./models/images/services.png[Servicepage, title="Services Page",100%, 100%, pdfwidth=100%, align=center]

[[Inventory]]
image::./models/images/inventory.png[Inventorypage,title="Lager Management Page", 100%, 100%, pdfwidth=100%, align=center]
...
[[DialogLandkarte]]
image::./models/images/Dialogue.jpg[Dialogue, title= "Dialogue Landkarte", 100%, 100%, pdfwidth=100%, align=center]
