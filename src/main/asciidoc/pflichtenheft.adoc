...
image::./models/images/sequence_diagramm_303.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 203 für {project_name} in UML", align=center]
