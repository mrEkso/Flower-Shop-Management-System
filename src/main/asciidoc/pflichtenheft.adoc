...
| v0.1 
| Zahlungsarten 
| Das System soll beim Kauf und Verkauf verschiedene Zahlungsarten anbieten, wie beispielsweise die Bezahlung in bar oder mit Karte, um eine flexible Zahlungsabwicklung zu gewährleisten.
