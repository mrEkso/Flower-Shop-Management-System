...
|2. Service|Erbt von der Klasse Ordner und enthält ein Client-Objekt sowie ein Date-Range-Attribut. Das Attribut frequence beschreibt, wie oft eine Lieferung erfolgen soll. 
...
|17. Reservation| erbt con der Klasse Ordner und enthält ein Client-Objekt und Date-Time-Attribut, was die Datum von der Reservierung beschreibt.
|===
