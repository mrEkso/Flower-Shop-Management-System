...
|0.1.1     | In Arbeit   | 21.10.2021          | Andrejs       | Stakeholders (Akteure)
|===
...
|===
|Name |Beschreibung
|Frau Rosa Floris  | Besitzerin - Verwaltung Finanzen und Lager
...
|Kunden  | Kaufen Einzelblumen oder Blumensträuße  
|Großhändler  | Verkaufen Blumen an das Unternehmen 
|Administratoren | Verwalten das System, erteilen die Berechtigungen für Nutzer
