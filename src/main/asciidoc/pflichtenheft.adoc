...
image::./models/images/analysis_class_d.svg[Analysenklassendiagramm, 100%, 100%, pdfwidth=100%, title= "Analysenklassendiagramm für {project_name} in UML", align=center]
