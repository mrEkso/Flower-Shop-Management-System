...
image::./models/images/sequence_diagram_101_d.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für {project_name} in UML", align=center]
...
image::./models/images/sequence_diagram_302_a.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für {project_name} in UML", align=center]
