...
Das System für Frau Rosa Floris' Blumenshop digitalisiert und vereinfacht verschiedene Geschäftsprozesse:|
	=-Finanzverwaltung: Das System hilft Frau Floris dabei, Rechnungen zu verwalten, Tegesrechnungen und Monatsrechnungen zu erstellen sowie den Verlust durch verwelkte Blumen zu kalkulieren.|
	=-Vertrieb und Verkauf: Der Vertrieb umfasst den Einkauf von Blumen als Rohstoff, den Verkauf von Blumen oder Boquets.|
	=-Lagermanagement: Frau Floris kann den Überblick über die verfügbare Ware behalten.|
	=-Serviceangebote: Das System unterstützt Dienstleistungen wie: das Dekorieren von Veranstltungen mit Blumen| regelmäßige Blumenlieferung| die Bereitstellung von Boquets und Blume zur Abholung im Lade. (wenn die Kunden spezielle Services und Angebote nutzen möchten).|
	==-Admin-Bereich: Der Administrator verwaltet Benutzerberechtigungen und simuliert den Großhändler-Katalog.|
...
image::./models/images/analysis_class_b.svg[Analysenklassendiagramm, 100%, 100%, pdfwidth=100%, title= "Analysenklassendiagramm für {project_name} in UML", align=center]
