...
Die Rechnungen lassen sich nach dem Einkauf erstellen. +
...
image::./models/images/sequence_diagram_101_c.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für {project_name} in UML", align=center]
...
Sales/Home Page für order management
[[Sales]]
image::./models/images/sales.png[Salespage, 100%, 100%, pdfwidth=100%, align=center]

Sales Page für Großhandler Bestellungen
[[Sales2]]
image::./models/images/sales2.png[Handlerpage, 100%, 100%, pdfwidth=100%, align=center]

Services Page
[[Services]]
image::./models/images/services.png[Servicepage, 100%, 100%, pdfwidth=100%, align=center]

Lager Management Page
[[Inventory]]
image::./models/images/inventory.png[Inventorypage, 100%, 100%, pdfwidth=100%, align=center]

Die Rechnung der Laden
[[Rechnung]]
image::./models/images/rechnung.png[Rechnungpage, 100%, 100%, pdfwidth=100%, align=center]
