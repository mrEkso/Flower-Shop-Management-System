...
|0.6.2     | In Arbeit    | 01.11.2024     | Andrejs    | Zusammenfassung erweitert
|===
...
image::./models/images/sequence_diagram_101_e.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 101 für {project_name} in UML", align=center]
...
image::./models/images/sequence_diagram_302_a.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 302 für {project_name} in UML", align=center]
