...
|2.1    | Aktualisiert    | 13.01.2025     | Andrejs    | Kundenwunsch (Gutscheinkarten) ergänzt.
|===
...
|Extensions                 |-
|Funktionale Anforderungen    |<<F0004>>, <<F0301>>
|===
...
|Extensions                 |-
|Funktionale Anforderungen    |<<F0101>>, <<F0103>>, <<F0008>>, , <<F9990>>
|===
...
| v0.1
| Rechnungen ansehen
| Das System soll es ermöglichen, Rechnungen einzusehen, damit Benutzer jederzeit Zugriff auf die Details von Transaktionen, Ein- und Ausgaben haben, um Finanzinformationen effizient zu überwachen.
...
| [[F0005]]<<F0005>>
| v0.1 
| Kassenstand sehen, aktualisieren 
...
| Das System soll alle Rechnungen als PDF exportieren und herunterladen können, um eine einfache Speicherung und Weitergabe zu ermöglichen.

| [[F0007]]<<F0007>>
| v0.1
| Rechnungen filtern
| Das System soll eine Filterfunktion für Rechnungen bieten, damit Benutzer spezifische Transaktionen basierend auf bestimmten Kriterien schnell finden können. Die Filterfunktion soll es ermöglichen, nach Datum, Betrag, Kundenname und Transaktionstyp zu suchen, um gezielt Rechnungen anzuzeigen.

| [[F0008]]<<F0008>> 
| v0.2  
| Zahlungsarten 
| Das System soll beim Verkauf verschiedene Zahlungsarten anbieten, wie beispielsweise die Bezahlung in bar oder mit Karte, um eine flexible Zahlungsabwicklung zu gewährleisten.
...
| v0.1
| Warenkorb
| Das System sollte beim Kauf von Blumen für das Geschäft oder beim Verkauf von Blumen an Kunden eine Warenkorbfunktion bieten, die es ermöglicht, Blumen hinzuzufügen und zu entfernen und die Bestellmenge anzupassen. Der Warenkorb sollte die Anzahl der ausgewählten Artikel und den Gesamtbetrag anzeigen, um den Bestellvorgang effizient zu gestalten.
...
| v0.1 
| Lieferung
| Das System soll die Möglichkeit bieten, Blumenlieferungen für Veranstaltungen und verschiedene andere Services zu organisieren. Diese Lieferungen sollen zusätzlich berechnet werden, um eine flexible und an den Kundenbedarf angepasste Dienstleistung zu gewährleisten.

| [[F0206]]<<F0206>> 
| v0.1 
| Informationen zu Produkttypen in Services anzeigen 
| Das System soll die Möglichkeit bieten, Informationen über die Produkttypen wie Blumengießen, Lieferung oder das Erstellen eines Straußes in den Services anzuzeigen. Bei der Erstellung eines Services soll es möglich sein, den Typ des Services sowie die Art der für die Ausführung erforderlichen Arbeit auszuwählen.
...
| [[F0302]]<<F0302>>
| v0.1 
| Blumen im Lager filtern, suchen 
...
| [[F0305]]<<F0305>>
| v0.1
| Lagerstand für Blumen reduzieren
| Das System soll es ermöglichen, den Lagerstand für Blumen zu reduzieren, insbesondere wenn Blumen verwelkt oder beschädigt sind, um eine genaue Bestandsverwaltung zu gewährleisten.
...
| [[F0402]]<<F0402>> 
| v0.1 
| Services und Reservierungen im Kalender anzeigen 
| Das System soll allgemeine Übersichten zu Services, wie Blumenausstattungen für Veranstaltungen oder Mehr- bzw. einmaliges Blumenservice, im Kalender anzeigen, um die Terminverwaltung zu unterstützen. Zusätzlich sollen auch Reservierungen von Blumen und Sträußen durch Kunden im Kalender sichtbar sein, um die Planung und Organisation effizienter zu gestalten. Es soll möglich sein, den Status der Reservierungen zu ändern und für jede Reservierung ein konkretes Datum und eine Uhrzeit festzulegen.

| [[F0403]]<<F0403>> 
| v0.1 
| Sonstige Termine im Kalender
| Das System soll die Möglichkeit bieten, verschiedene Termine im Kalender hinzuzufügen und anzuzeigen. Dies umfasst Funktionen wie das Eintragen und Anzeigen von arbeitsbezogenen Terminen, sowie das Hinzufügen von weniger arbeitsrelevanten Ereignissen, wie Feiertage oder Geburtstage, die zur besseren Arbeitsorganisation beitragen können.

| [[F0501]]<<F0501>> 
| v0.2
| Zugriffskontrolle und Berechtigungen 
| Das System soll Login- und Logout-Funktionen bieten, um die Sicherheit zu gewährleisten.

| [[F9990]]<<F9990>> (Abschließender Kundenwunsch)
| v0.1
| Gutscheinkarten
| Das System soll es ermöglichen, Kunden Gutscheinkarten zu erteilen, um dann beim Verkauf "Gutschein" als Zahlungsmethode zu wählen. Die Bilanz auf dem Gutschein soll dabei berücksichtigt und jeweils ggf. aktualisiert werden. 
...
a|
Die Reaktionszeit der Benutzeroberfläche soll nicht mehr als 2 Sekunden für jede Hauptfunktionalität betragen, wie das Abrufen des Lagerbestands, das Erstellen von Rechnungen und die Bearbeitung von Bestellungen.
...
image::./models/images/analysis_class_e.svg[Analysenklassendiagramm, 100%, 100%, pdfwidth=100%, title= "Analysenklassendiagramm für {project_name} in UML", align=center]
...
|2. Contract|Stellt die Verträge dar, für die die Leistungen von dem Laden mehrmals (am mehreren Tagen) geführt sind. Erbt von der Klasse Ordner und enthält ein oder mehr Client-Objekt sowie ein Date-Range-Attribut. Das Attribut frequence beschreibt, wie oft eine Lieferung erfolgen soll. 
|3. Reservation| Stellt eine Einmalige Reservierte Leistung (wie Blumen für Abholen oder Hochzeit). Erbt von der Klasse Ordner und enthält ein oder mehr Client-Objekt und Date-Time-Attribut, was die Datum von der Reservierung beschreibt.
|4.Invoice |Information über die Bezahlung. Jedes Invoice-Objekt hat eine einzigartige ID und eine PaymentMethod.
...
|<<UC301>>
|Blumen als Rohstoff einkaufen
|Blumen werden erfolgreich beim Großhändler gekauft und im Lagerbestand aktualisiert.
...
|<<UC302>>
|Blumen im Lager filtern, suchen
|Frau Floris kann alle Blumen bzw. Blumensträußen sehen und durch ein Suchfeld filtern.
|Frau Floris ist im System angemeldet und hat die entsprechenden Berechtigungen zum Lager.
|1. Frau Floris wählt Lagermodul aus. +
2. Sie kann alle Blumen bzw. Blumensträußen sehen. +
3. Sie kann die Produkte filtern durch ein Suchfeld.
...
|<<UC201>>
|Eine Veranstaltung mit Blumen ausstatten
|Ein Kunde hat die Möglichkeit, eine Veranstaltung mit Blumen ausstatten zu lassen, indem er den Service des Blumenshops bucht. Die Nichte organisiert die Lieferung und arrangiert die Blumen vor Ort
|Blumen und Materialien für die Veranstaltung sind auf Lager und der Kunde hat eine Veranstaltung gebucht.
|1. Kunde kontaktiert den Blumenshop (Frau Rosa) und bucht den Blumenservice für eine Veranstaltung. +
2. Nichte überprüft die benötigten Blumen und Materialien im Lagerbestand. +
3. Nichte plant die Lieferung und arrangiert die Blumen vor Ort für die Veranstaltung.
...
|**<<ATF-UC202>>**
|<<UC202>>
|Ein- bzw. mehrmaliges Blumenservice
|Ein Kunde hat die Möglichkeit, einen einmaligen oder wiederkehrenden Blumenservice für verschiedene Anlässe (z. B. Hochzeiten, Firmenveranstaltungen) zu buchen. Die Nichte organisiert die Lieferung und stellt sicher, dass die Blumen regelmäßig oder wie gewünscht vor Ort arrangiert werden.
|Kunde möchte einen einmaligen oder regelmäßigen Blumenservice buchen.
|1. Kunde kontaktiert den Blumenshop und wählt zwischen einem einmaligen und einem mehrmaligen Blumenservice. +
2. Kunde legt den gewünschten Zeitraum und die Häufigkeit der Lieferungen fest. +
3. Nichte überprüft die Lagerbestände und stellt die erforderlichen Blumen und Materialien zusammen. +
4. Nichte organisiert die Lieferung und arrangiert bzw. pflegt die Blumen entweder einmalig oder regelmäßig nach den Vorgaben des Kunden vor Ort.
...
|<<UC203>>
|Blumen zur Abholung im Laden
|Ein Kunde hat die Möglichkeit, eine "Rerservierung" oder Kauf zur Abholung im Laden zu betätigen. Die Blumen sind zur vereinbarten Zeit zum Abholung verfügbar.
|Die gewünschten Blumen sind im Lager verfügbar oder wurden rechtzeitig bestellt und vorbereitet.
|1. Kunde kontaktiert den Blumenshop und gibt Frau Floris an, dass er Blumen zur Abholung im Laden wünscht. +
2. Kunde wählt zwischen einer einmaligen Abholung und einem regelmäßigen Abholservice. +
3. Nichte prüft die Verfügbarkeit der Blumen im Lager und reserviert die benötigten Blumen für die Abholung. +
4. Nichte informiert den Kunden über den Abholzeitpunkt und stellt die Blumen im Laden zur Verfügung. +
...
|<<UC401>>
|Kalender navigieren
|Ein Mitarbeiter hat die Möglichkeit, Kalender zu navigieren.
|Man hat die entsprechende Berechtigung.
|1. Ein Mitarbeiter wählt Kalendermodul aus. +
2. Der Mitarbeiter kann den Kalender navigeren, indem er die Daten ändern und Termine sehen kann.
...
|**<<ATF-UC402>>**
|<<UC402>>
|Services im Kalender
|Sämtliche Dienstsleistungen des Ladens werden in den Kalender automatisch eingetragen.
|Man hat die entsprechende Berechtigung.
|1. Ein Mitarbeiter wählt Kalendermodul aus. +
2. Der Mitarbeiter kann im Kalender den korrekten Servicetermin sehen.
...
|<<UC403>>
|Sonstige Termine im Kalender
|Ein Mitarbeiter hat die Möglichkeit, im Kalender einen beliebigen (auch nicht Businessbezogenenen) Termin anlegen.
|Man hat die entsprechende Berechtigung.
|1. Ein Mitarbeiter wählt Kalendermodul aus. +
2. Der Mitarbeiter wählt die Funktion "Neuer Termin" aus. +
3. Der Mitarbeiter trägt benötigte Daten zur Terminerstellung ein. +
4. Der kann den neuen Termin im Kalender sehen.
|===
