...
image::./models/images/sequence_diagram_101_g.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 101 für {project_name} in UML", align=center]
...
image::./models/images/sequence_diagram_302_c.svg[sequence diagram, 100%, 100%, pdfwidth=100%, title= "Sequenzdiagramm für Anwendungsfall 302 für {project_name} in UML", align=center]
