...
public class ContractOrder extends AbstractOrder {
	 ...
	 */
	public ContractOrder(UserAccount user, String contractType, String frequency, LocalDate startDate, LocalDate endDate, String address, Client client, String notes) {
		super(user, notes);
		this.client = client;
