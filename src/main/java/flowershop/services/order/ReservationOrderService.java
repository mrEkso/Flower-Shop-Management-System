...
public class ReservationOrderService {
	...
	public ReservationOrderService(OrderFactoryRepository orderFactoryRepository, ProductCatalog productCatalog, OrderManagement<ReservationOrder> orderManagement) {
